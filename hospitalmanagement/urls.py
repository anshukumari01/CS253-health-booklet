...
urlpatterns = [
    ...
    path('admin-view-doctor-id', views.admin_view_doctor_view_id,
         name='admin-view-doctor-id'),
    ...
    path('admin-view-patient-id', views.admin_view_patient_view_id,
         name='admin-view-patient-id'),
    ...
    path('admin-view-appointment-pt', views.admin_view_appointment_view_pt,
         name='admin-view-appointment-pt'),
